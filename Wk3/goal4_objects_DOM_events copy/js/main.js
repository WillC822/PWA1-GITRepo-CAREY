...
console.log('------Object within an object, Arrays, Function ----------');
    ...
    console.log(thatGuy.address.street + ','+this.address.city);
...
// 	by using their name as a string - all of the below are valid:
    ...
    console.log(fs.student.age);  //dot way of accessing information

    console.log(fsStudent['age']);  // array method of accesssing information
...
console.log('------------ querySelectorAll -------------------');
    ...
    var cf = document.querySelectorAll()
